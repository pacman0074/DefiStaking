...
//This function proceed a swap of tokens trhough uniswap V3 SDK
//It takes two argument : -tokenAddress (address of the token received for the swap),  -amount(amount in ETH to be swapped)

async function Swap( tokenAddress, amount) {

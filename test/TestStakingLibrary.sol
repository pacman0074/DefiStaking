...
contract TestStakingLibrary {
    ...
    function testgetIndexTokenStaked() public {
        ...
        StakingLibrary.Position memory PositionWETH = StakingLibrary.Position(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2, 10, 0, 0, 0, 0);
        StakingLibrary.Position memory PositionLINK = StakingLibrary.Position(0x514910771AF9Ca656af840dff83E8264EcF986CA, 90, 0, 0, 0, 0);
        StakingLibrary.Position memory PositionMANA = StakingLibrary.Position(0x0F5D2fB29fb7d3CFeE444a200298f468908cC942, 50, 0, 0, 0, 0);
        StakingLibrary.Position memory PositionUSDT = StakingLibrary.Position(0xdAC17F958D2ee523a2206206994597C13D831ec7, 90, 0, 0, 0, 0);
